...
# The `age` should be greater than zero and less than 65
    ...
    if age < 1:
        recommendation = "Sorry, but this is not a acceptable age"

    elif age > 0 and age < 65:
        recommendation = "Please call our Toll Free number for a personalized investment recommendation"


# The `investment_amount` should be equal to or greater than 5000.

    if investment_amount < 5000:
        recommendation ="The minimum acceptable investment amount is $5000"

# Risk vs. Investment amount 
        ...
        recommendation = "Please consult with one of our invest professionals to understand the BEST RISK to REWARD STRATEGIES"
